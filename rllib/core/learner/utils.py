...
from ray.rllib.utils.framework import try_import_torch, try_import_mindspore
from ray.rllib.utils.typing import NetworkType
from ray.util import PublicAPI


torch, _ = try_import_torch()
mindspore, _try_import_mindspore
...
def make_target_network(main_net: NetworkType) -> NetworkType:
    ...
    elif isinstance(main_net, mindspore.nn.Cell):
        target_net.requires_grad_(False)
    else:
...
def update_target_network(
    *,
    ...
    if isinstance(main_net, torch.nn.Module):
        ...
        from ray.rllib.utils.mindspore_utils import update_target_network as _update_target
