...
from ray.rllib.core.testing.MindSpore.bc_module import DiscreteBCMindSporeModule
from ray.rllib.core.testing.torch.bc_module import DiscreteBCTorchModule
from ray.rllib.core.testing.torch.bc_learner import BCTorchLearner
from ray.rllib.core.testing.MindSpore.bc_learner import BCMindSporeLearner
...
class BCConfigTest(AlgorithmConfig):
    ...
    def get_default_rl_module_spec(self):
        if self.framework_str == "torch":
            ...
            return RLModuleSpec(module_class=DiscreteBCMindSporeModule)
...
class BCAlgorithmTest(Algorithm):
    ...
    def get_default_policy_class(cls, config: AlgorithmConfig):
        ...
        elif config.framework_str == "mindspore":
            return MindSporePolicyV2
