"""MindSpore model for DQN"""

from typing import Sequence
import gymnasium as gym
from ray.rllib.models.MindSpore.misc import SlimFC
from ray.rllib.models.MindSpore.modules.noisy_layer import NoisyLayer
...
class DQNMindSporeModel(MindSporeModelV2, nn.Cell):
    """Extension of standard MindSporeModelV2 to provide dueling-Q functionality."""
    ...
    def __init__(
        ...
        *,
        ...
        super(DQNMindSporeModel, self).__init__(
