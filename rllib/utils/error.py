...
"""  # noqa
ERR_MSG_MINDSPORE_POLICY_CANNOT_SAVE_MODEL = """Could not save MINDSPORE model under self[MINDSPOREPolicy].model!
    This is most likely due to the fact that you are using an Algorithm that
    uses a Catalog-generated MINDSPOREModelV2 subclass, which is MINDSPORE.save() cannot pickle.
"""  # noqa
# -------
