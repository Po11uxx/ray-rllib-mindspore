...
from ray.rllib.algorithms.dqn.MindSpore.mindspore_noisy_linear import NoisyLinear
from ray.rllib.core.columns import Columns
from ray.rllib.core.models.base import Encoder, ENCODER_OUT, Model
from ray.rllib.core.models.MindSpore.base import TorchModel
...
class TorchNoisyMLP(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.expected_input_dtype = mindspore.float32
