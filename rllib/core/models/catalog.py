    ...
    def _get_dist_cls_from_action_space(
        ...
        *,
        ...
        if framework == "torch":
            ...
            distribution_dicts = {
                DistEnum.Deterministic: MindSporeDeterministic,
                DistEnum.DiagGaussian: MindSporeDiagGaussian,
                DistEnum.Categorical: MindSporeCategorical,
            }
        elif framework == "tf2":
...
def _multi_action_dist_partial_helper(
    ...
    if framework == "torch":
        ...
        multi_action_dist_cls = MindSporeMultiDistribution
    elif framework == "tf2":
...
def _multi_categorical_dist_partial_helper(
    ...
    if framework == "torch":
        ...
        from ray.rllib.models.MindSpore.mindspore_distributions import MindSporeMultiCategorical

        multi_categorical_dist_cls = MindSporeMultiCategorical
    elif framework == "tf2":
