...
if TYPE_CHECKING:
    ...
    from ray.rllib.utils import try_import_jax, try_import_tf, try_import_torch, try_import_mindspore
...
TensorType = Union[np.array, "jnp.ndarray", "tf.Tensor", "torch.Tensor", "mindspore.Tensor"]
...
# A neural network
NetworkType = Union["torch.nn.Module", "mindspore.nn.Cell", "tf.keras.Model"]
...
LocalOptimizer = Union["torch.optim.Optimizer", "tf.keras.optimizers.Optimizer", "mindspore.nn.Optimizer"]
Optimizer = LocalOptimizer
Param = Union["torch.Tensor", "tf.Variable", "mindspore.Tensor"]
ParamRef = Hashable
