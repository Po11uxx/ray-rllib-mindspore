...
class PPOConfig(AlgorithmConfig):
    ...
    def get_default_rl_module_spec(self) -> RLModuleSpec:
        ...
        if self.framework_str == "torch":
            ...
            from ray.rllib.algorithms.ppo.MindSpore.ppo_mindspore_rl_module import (
                PPOMindSporeRLModule,
            )

            return RLModuleSpec(module_class=PPOMindSporeRLModule, catalog_class=PPOCatalog)
            ...
            raise ValueError(
                ...
                "Use either 'torch' or 'tf2' or 'mindspore'."
            )
    ...
    def get_default_learner_class(self) -> Union[Type["Learner"], str]:
        ...
        if self.framework_str == "mindspore":
            from ray.rllib.algorithms.ppo.MindSpore.ppo_mindspore_learner import (
                PPOMindSporeLearner,
            )

            return PPOMindSporeLearner
