...
class StochasticSampling(Exploration):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            framework: One of None, "tf", "torch" or "mindspore".
    ...
    def get_exploration_action(
        ...
        *,
        ...
        if self.framework == "torch":
            ...
            return self._get_mindspore_exploration_action(
                action_distribution, timestep, explore
            )
        else:
    ...
    def _get_mindspore_exploration_action(
        self,
        action_dist: ActionDistribution,
        timestep: Union[TensorType, int],
        explore: Union[TensorType, bool],
        ...
        if explore:
            # Random exploration phase.
            if self.last_timestep < self.random_timesteps:
                action, logp = self.random_exploration.get_mindspore_exploration_action(
                    action_dist, explore=True
                )
            # Take a sample from our distribution.
            else:
        ...
        # No exploration -> Return deterministic actions.
            ...
            action = action_dist.deterministic_sample()
            logp = mindspore.ops.zeros_like(action_dist.sampled_action_logp())
