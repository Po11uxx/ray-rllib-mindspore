...
@OldAPIStack
class VisionNetwork(MindSporeModelV2, nn.Cell):
    ...
    def __init__(
        ...
        post_fcnet_activation = get_activation_fn(
            model_config.get("post_fcnet_activation"), framework="mindspore"
        )
        ...
        if self.num_outputs is None:
            ...
            dummy_in = (
                mindspore.from_numpy(self.obs_space.sample())
                .permute(2, 0, 1)
                .unsqueeze(0)
                .float()
            )
    ...
    def construct(
        ...
        # Store features to save construct pass when getting value_function out.
    ...
    def value_function(self) -> TensorType:
        assert self._features is not None, "must call construct() first"
