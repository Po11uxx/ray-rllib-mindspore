...
from ray.rllib.models.MindSpore.mindspore_distributions import MindSporeSquashedGaussian
...
class SACCatalog(Catalog):
    ...
    def build_qf_encoder(self, framework: str) -> Encoder:
        ...
        Args:
            framework: The framework to use. Either `torch` or `tf2` or `mindspore`.
    ...
    @override(Catalog)
    def get_action_dist_cls(self, framework: str) -> "MindSporeSquashedGaussian":
        assert framework == "mindspore"
        return MindSporeSquashedGaussian
