...
from ray.rllib.models.MindSpore.misc import (
    normc_initializer as mindspore_normc_initializer,
    SlimFC,
)
from ray.rllib.models.catalog import ModelCatalog
from ray.rllib.models.MS_Modelv2 import MS_ModelV2, restore_original_dimensions
...
from ray.rllib.utils.mindspore_utils import one_hot

mindspore, nn = try_import_mindspore()


@OldAPIStack
class ComplexInputNetwork(MindSporeModelV2, nn.Cell):
    """MindSporeModelV2 concat'ing CNN outputs to flat input(s), followed by FC(s).
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        self.cnns = nn.CellDict()
        self.one_hot = nn.CellDict()
        self.flatten_dims = {}
        self.flatten = nn.CellDict()
        concat_size = 0
        ...
        if num_outputs:
            ...
            self.logits_layer = SlimFC(
                ...
                activation_fn=None,
                initializer=mindspore_normc_initializer(0.01),
            )
    ...
    def construct(self, input_dict, state, seq_lens):
        if SampleBatch.OBS in input_dict and "obs_flat" in input_dict:
            ...
            orig_obs = restore_original_dimensions(
                input_dict[SampleBatch.OBS], self.processed_obs_space, tensorlib="mindspore"
            )
        ...
        for i, component in enumerate(tree.flatten(orig_obs)):
            ...
            if i in self.cnns:
                ...
                if component.dtype in [
                    mindspore.QuantDtype.int8,
                    mindspore.QuantDtype.int16,
                    # mindspore.QuantDtype.int32, TODO: to be determined
                    # mindspore.QuantDtype.int64,
                    mindspore.QuantDtype.uint8,
                ]:
                    one_hot_in = {
                ...
                nn_out, _ = self.flatten[i](
                    SampleBatch(
                        {
                            SampleBatch.OBS: mindspore.ops.reshape(
        ...
        out = mindspore.ops.cat(outs, dim=1)
        ...
        self._value_out = mindspore.ops.reshape(values, [-1])
        return logits, []
