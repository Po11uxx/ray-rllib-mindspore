...
class SACMindSporeRLModule(MindSporeRLModule, SACRLModule):
    ...
    def _forward_train(self, batch: Dict) -> Dict[str, Any]:
        ...
        # here). This is different from doing `.detach()` or `with mindspore.no_grads()`,
