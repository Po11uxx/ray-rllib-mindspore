...
class LearningRateSchedule:
    """Mixin for MindSporePolicy that adds a learning rate schedule."""
...
class EntropyCoeffSchedule:
    """Mixin for MindSporePolicy that adds entropy coeff decay."""
...
@OldAPIStack
class KLCoeffMixin:
    """Assigns the `update_kl()` method to a MindSporePolicy.
...
class ValueNetworkMixin:
    """Assigns the `_value()` method to a MindSporePolicy.
...
class TargetNetworkMixin:
    ...
    def set_weights(self, weights):
        ...
        # at the same time.
        MindSporePolicy.set_weights(self, weights)
        self.update_target()
