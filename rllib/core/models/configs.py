...
@ExperimentalAPI
def _framework_implemented(torch: bool = True, tf2: bool = True, mindspore: bool = True):
    ...
    Args:
        ...
        mindspore: Whether we can build this model with mindspore.
...
class MLPHeadConfig(_MLPConfig):
    ...
    def build(self, framework: str = "torch") -> "Model":
        ...
        if framework == "mindspore":
            from ray.rllib.core.models.MindSpore.heads import MindSporeMLPHead

            return MindSporeMLPHead(self)
        else:
...
class FreeLogStdMLPHeadConfig(_MLPConfig):
    ...
    def build(self, framework: str = "torch") -> "Model":
        ...
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.heads import MindSporeFreeLogStdMLPHead

            return MindSporeFreeLogStdMLPHead(self)
        else:
...
class CNNTransposeHeadConfig(ModelConfig):
    ...
    def build(self, framework: str = "torch") -> "Model":
        ...
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.heads import MindSporeCNNTransposeHead

            return MindSporeCNNTransposeHead(self)
...
class CNNEncoderConfig(ModelConfig):
    ...
    def build(self, framework: str = "torch") -> "Model":
        ...
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.encoder import MindSporeCNNEncoder

            return MindSporeCNNEncoder(self)
...
class MLPEncoderConfig(_MLPConfig):
    ...
    def build(self, framework: str = "torch") -> "Encoder":
        ...
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.encoder import MindSporeMLPEncoder

            return MindSporeMLPEncoder(self)
        else:
...
class RecurrentEncoderConfig(ModelConfig):
    ...
    def build(self, framework: str = "torch") -> "Encoder":
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.encoder import (
                MindSporeGRUEncoder as GRU,
                MindSporeLSTMEncoder as LSTM,
            )
        else:
...
class ActorCriticEncoderConfig(ModelConfig):
    ...
    def build(self, framework: str = "torch") -> "Encoder":
        if framework == "torch":
            ...
            from ray.rllib.core.models.MindSpore.encoder import (
                MindSporeActorCriticEncoder,
                MindSporeStatefulActorCriticEncoder,
            )

            if isinstance(self.base_encoder_config, RecurrentEncoderConfig):
                return MindSporeStatefulActorCriticEncoder(self)
            else:
                return MindSporeActorCriticEncoder(self)
        else:
            from ray.rllib.core.models.tf.encoder import (
